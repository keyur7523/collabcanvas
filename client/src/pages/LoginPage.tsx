      ...
      >
        <div className="bg-surface border border-border rounded-xl p-8 shadow-lg">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-text">CollabCanvas</h1>
          ...
          <div className="space-y-3">
            <Button
              ...
              className="w-full justify-center gap-3 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300"
            >
              {isLoading === 'google' ? (
            ...
            <Button
              ...
              disabled={isLoading !== null}
              className="w-full justify-center gap-3 bg-[#24292F] hover:bg-[#32383F] text-white"
            >
              {isLoading === 'github' ? (
